...
import { Award, BookOpen, CheckCircle2, Settings, User, XCircle } from "lucide-react";
...
export default function ProfilePage() {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-md bg-black px-5 pb-28 pt-8 text-white">
      ...
      {message ? (
        <div className="mt-8 rounded-2xl border border-white/10 bg-zinc-900 p-5 text-center text-zinc-400">
          {message}
          <button
